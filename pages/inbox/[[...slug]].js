                    ...
                    <a className={styles.link}>
                        <div className={styles.details}>
                            ...
                            <div className={styles.content}>
                                ...
                                <p className={styles.blurb}>Hi DigitalSisterHood we would like to partner with you on our next hijab drops...</p>
                            </div>
                        </div>
                    </a>
                </Link>
                    ...
                    <div className={styles.wrap}>
                        ...
                        <div className={styles.content}>
                            <div className={styles.emptyThread}>
                                ...
                                <Button
                                    type="primary"
                                    onClick={() => alert("Open Composer")}
                                >Send a Care Package</Button>
                            </div>
                        </div>
                    </div>
                </div>
...
export async function getServerSideProps(ctx) {
    const {props: {account}} = await getAccount(ctx, true, true);
